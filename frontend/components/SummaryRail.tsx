    ...
    <div className="right-rail">
      ...
      <div className="panel-card">
        ...
        <div className="readout-grid">
          ...
          <span>{pokemon?.types.length ? pokemon.types.join(' / ') : '-'}</span>
          ...
          <span>{pokemon?.forms.length ? pokemon.forms.join(', ') : '-'}</span>
        </div>
      </div>
      ...
      <div className="panel-card">
        ...
        <p className="notes-copy">
          A perfect result shows the maximum IV or DV for that generation. Wide ranges usually mean lower levels or uncertain effort values.
        </p>
      </div>
    </div>
  );
